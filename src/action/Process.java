            ...
            while(true)
            {
                ...
                for(int i=0;i<dt.Agent;i++)
                {
                    ...
                    for(int j=0;j<dt.State;j++)
                    {
                        ...
                        System.out.println("State for Agent"+(i+1)+" - "+dt+" = "+c+","+it+" : "+price1.get(it-1));
                        c=c-1;
                        it=it-1;
                    ...
                    System.out.println("action1= "+at1);
                    System.out.println("action2= "+at2);
                    // Reward computation
                ...
                System.out.println("Joint Action learning === ");
